...
public class WallStickA : MonoBehaviour
{
	...
	public ChangeDirectionA change;
	public Material yellow;

    void Start()
    {
        stick = GameObject.Find("StickA").GetComponent<FloatingJoystick>();
	...
	change = GameObject.Find("ChangeDirectionA").GetComponent<ChangeDirectionA>();
	change.rotate = 1;
